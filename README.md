...
cd to the folder containing pychat.py run
bash
Copy
python pychat.py
Configuration
...
Select your preprompt before sending messages You can set default preprompts or configure the application to always use the last selected preprompt.
Sending Messages
